-- Script de creación de esquema para RenaceGest
-- Ejecutar este script una vez en cada base de datos:
--   1) renagest (entorno REAL)
--   2) renagest_prueba (entorno PRUEBA)
