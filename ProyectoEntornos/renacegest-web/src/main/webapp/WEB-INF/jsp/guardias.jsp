                            ...
                            <form class="form-grid" method="post" action="${pageContext.request.contextPath}/guardias">
                                ...
                                <label>
                                    ...
                                    <div class="password-field">
                                        <input id="crearClaveAcceso" type="password" name="claveAcceso"
                                            autocomplete="new-password" autocapitalize="off" autocorrect="off"
                                            spellcheck="false" required>
                                        <button class="password-toggle" type="button" data-target="crearClaveAcceso"
                        ...
                        <article class="panel">
                            ...
                            <form class="form-grid" method="post" action="${pageContext.request.contextPath}/guardias">
                                ...
                                <label>
                                    ...
                                    <div class="password-field">
                                        <input id="actualizarClaveAcceso" type="password" name="claveAcceso"
                                            autocomplete="new-password" autocapitalize="off" autocorrect="off"
                                            spellcheck="false">
                                        <button class="password-toggle" type="button"
                                            data-target="actualizarClaveAcceso"
                                            aria-label="Mostrar u ocultar la clave">Ojo</button>
                                    </div>
                                </label>
                                <label>
