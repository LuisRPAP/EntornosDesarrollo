<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <body>
            <div class="app-shell app-shell-fixed grupos-shell">
                <%@ include file="_topnav.jspf" %>
                    ...
                    <c:if test="${not canManageGroups}">
                        <div class="notice">Tu rol tiene acceso de lectura en grupos. Solo Maestre o Sargento pueden
                            modificar.</div>
                    </c:if>
                        ...
                        <section class="panel-grid">
                            <article class="panel">
                                ...
                                <form class="form-grid" method="post"
                                    action="${pageContext.request.contextPath}/grupos">
                            ...
                            <article class="panel">
                                ...
                                <form class="form-grid" method="post"
                                    ...
                                    <div class="button-row">
                                        <button class="button button-primary" name="accion" value="agregar"
                                            type="submit">Añadir miembro</button>
                                        <button class="button button-secondary" name="accion" value="quitar"
                                            type="submit">Quitar miembro</button>
                                    </div>
                                </form>
                            </article>
                        </section>
                    ...
                    <section class="panel">
                        <h2>Vista de resumen</h2>
                        <p class="panel-intro">La previsualizacion completa de etiquetas y miembros se ha movido para
                            aligerar esta pantalla.</p>
                        <a class="button button-secondary"
                            href="${pageContext.request.contextPath}/grupos-resumen">Abrir resumen de grupos</a>
                    </section>
            </div>
        </body>
