...
<div class="app-shell">
    <header class="page-head">
        ...
        <a class="button button-secondary" href="${pageContext.request.contextPath}/amigos">Volver a galeria</a>
    </header>
                    ...
                    <c:forEach items="${historial}" var="alarde">
                        <article class="message-card">
                            <div class="message-meta">
                                ...
                                <span>Entrada: ${empty alarde.fechaEntrada ? 'Pendiente' : alarde.fechaEntrada}</span>
                            </div>
                            <p>Guardia participante: ${alarde.guardiaApodo}</p>
                            <small>
                                ${alarde.ticketMaestranza ? 'La pieza paso por revision de maestranza.' : 'Custodia sin incidencias graves.'}
                            </small>
                        </article>
                    </c:forEach>
                </div>
